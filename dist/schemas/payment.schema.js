import { z } from "zod";
/**
 * Esquema de validación para cargos de pago
 *
 * Define las reglas de validación para los datos de entrada de cargos
 * Utiliza Zod para validación tipo-first con TypeScript
 */
export const PaymentChargeSchema = z.object({
    ...
    method: z
        ...
        invalid_type_error: "El método de pago debe ser uno de: credit_card, debit_card, transfer, cash",
    })
        .optional(),
    description: z
        .string({
