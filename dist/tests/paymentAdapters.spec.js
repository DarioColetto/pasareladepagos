...
describe("StripeAdapter", () => {
    ...
    it("pay() debe llamar al SDK y devolver un ChargeResult normalizado", async () => {
        ...
        expect(chargesCreate).toHaveBeenCalledWith(expect.objectContaining({
            amount: input.amount,
        }));
    ...
    it("refund() debe llamar al SDK y devolver un RefundResult normalizado", async () => {
        ...
        expect(refundsCreate).toHaveBeenCalledWith(expect.objectContaining({
...
describe("MpAdapter", () => {
    ...
    it("pay() debe llamar a payments.create y devolver un ChargeResult normalizado", async () => {
        ...
        expect(paymentsCreate).toHaveBeenCalledWith(expect.objectContaining({
    ...
    it("refund() debe llamar a payments.refund y devolver un RefundResult normalizado", async () => {
        ...
        expect(paymentsRefund).toHaveBeenCalledWith(input.paymentId, expect.objectContaining({
            amount: input.amount,
        }));
