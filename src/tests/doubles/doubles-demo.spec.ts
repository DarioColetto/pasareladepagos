...
import type { ChargeInput, RefundInput } from '../../core/payments/PaymentTypes';
...
describe('Dobles de Prueba - Demostración', () => {
  describe('DummyPaymentProvider', () => {
    it('debe lanzar error al intentar usar métodos del dummy', async () => {
      ...
      const inputCargo: ChargeInput = { amount: 100, currency: 'ARS', token: 'test' };
      const inputReembolso: RefundInput = { paymentId: 'test', amount: 50 };
  ...
  describe('AlwaysApprovedStub', () => {
    it('debe siempre aprobar pagos', async () => {
      ...
      const input: ChargeInput = { amount: 100, currency: 'ARS', token: 'test' };
    ...
    it('debe siempre aprobar reembolsos', async () => {
      const stub = new AlwaysApprovedStub();
      const input: RefundInput = { paymentId: 'test', amount: 50 };
  ...
  describe('FlakyPaymentStub', () => {
    let flakyStub: FlakyPaymentStub;
    ...
    it('debe alternar entre éxito y falla en reembolsos', async () => {
      const input1: RefundInput = { paymentId: 'test1', amount: 50 };
      const input2: RefundInput = { paymentId: 'test2', amount: 30 };
  ...
  describe('SpyPaymentProvider', () => {
    ...
    it('debe registrar llamadas al método refund', async () => {
      const input: RefundInput = { paymentId: 'test123', amount: 50 };
