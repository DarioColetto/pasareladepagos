...
/**
 * Esquema de validación para reembolsos de pago
 * 
 * Define las reglas de validación para los datos de entrada de reembolsos
 */
...
/**
 * Tipo TypeScript inferido del esquema de validación de reembolsos
 */
